# Tabla de frecuencias — Índice del curso

tags: #estadística #notebooklm #youtube
...
| Clase | Tema | Estado |
|-------|------|--------|
| [[Clase 01 - Tablas de Frecuencia y Regla de Sturges|01]] | Simple Frequency Table | Example 1 + Tablas de frecuencia si | ⏳ |
| [[Clase 02 - Tablas de frecuencias agrupadas por intervalos|02]] | Frequency table grouped by intervals | Example 1 + Frequency | ⏳ |
| 3 | Frequency tables grouped into intervals | Introduction + Fre | ⏳ |
